...
func main() {
	// parse args
	deviceID := 0
	model := "C://Users/trj/Project/GO/FaceRocognize/tensorflow_inception_graph.pb"
	descr := "C://Users/trj/Project/GO/FaceRocognize/imagenet_comp_graph_label_strings.txt"
	...
	backend = gocv.ParseNetBackend("opencv")
	target := gocv.NetTargetCPU
	target = gocv.ParseNetTarget("cpu")
